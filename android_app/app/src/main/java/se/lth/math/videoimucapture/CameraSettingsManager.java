...
class CameraSettingVideoSize extends CameraSetting {
    ...
    private static Size DEFAULT_VIDEO_SIZE = new Size(800, 600);
...
class CameraSettingFocusMode extends CameraSetting {
    ...
    private final FocusMode DEFAULT_FOCUS_MODE = FocusMode.MANUAL;
...
class CameraSettingExposureMode extends CameraSetting {
    ...
    private final Mode DEFAULT_MODE = Mode.CONTINUOUS_AUTO;
